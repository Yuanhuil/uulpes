	...
	*/
	...
	var methods = {
			...
			for (var i = 0, field_errors = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "creditCard":
						...
						break;
					case "chinaIDCard":
						errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._chinaIDCard);
						break;
					case "condRequired":
		...
		*/
		...
		_chinaIDCard:function(field, rules, i, options){
			var code = field.val();
			var rule = options.allrules.chinaIDCard;
