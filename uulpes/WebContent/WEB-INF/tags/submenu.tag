...
<%@ attribute name="menu" type="com.njpes.www.entity.baseinfo.Menu" required="true" description="当前菜单" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
<%@ taglib prefix="njpes" tagdir="/WEB-INF/tags" %>
<c:choose>
