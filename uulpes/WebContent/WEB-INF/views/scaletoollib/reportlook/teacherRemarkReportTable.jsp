...
<div class="tableContent">
	<table>
	  <thead>
		...
		<c:forEach var="examResultTeacher" items="${elistTeacherRemarkReport }">
			<tr>
				<td>
				...
				<td width="7%">
				  <a style="color:blue;" href="../../assessmentcenter/report/teacherRemarkReport.do?userid=${examResultTeacher.teacherId}"  target="_blank">查看</a>
				  <a style="color:blue;" href="../../assessmentcenter/report/downloadTeacherRemarkReport.do?userid=${examResultTeacher.teacherId}&download=yes">下载</a> 
				</td>
			</tr>
		</c:forEach>
	</table>
