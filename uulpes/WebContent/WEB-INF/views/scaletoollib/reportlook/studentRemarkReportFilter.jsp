...
<c:set var="stuRemarkReportStuUrl"
	value="../../scaletoollib/reportlook/searchStuRemarkReportStuUrl.do"></c:set>
<form:form id="studentRemarkReportForm"
	name="studentRemarkReportForm" method="post"
	commandName="reportLookStudentFilterParam"
	action="${stuRemarkReportStuUrl }">
	...
	<div class="buttonContent">
			...
			<input class="button-small blue" type="button" value="重置"	onclick="RemarkCommentsReset();" />
		
	</div>
</form:form>
<script type="text/javascript">
	function RemarkCommentsReset() {
		$("#studentRemarkReportForm")[0].reset();
