...
<div id="importdialog" title="文件导入">
	<table>
		<tr>
			<td>1.下载<!-- <a href="${ctx }/excel/workschedule/导入会议记录_新模板.xlsx" target="_blank">导入会议记录模板</a>-->
			<a href="javascript:void(0);" onclick="downloadtemplate();">会议记录模板</a>；<br>
			    2.按照模板的要求进行填写；<br>
...
function downloadtemplate(){
	var url = "${ctx }/workschedule/congress/downloadtemplate.do";
