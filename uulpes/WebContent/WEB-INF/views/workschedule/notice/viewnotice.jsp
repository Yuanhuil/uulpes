	...
	<form:form action="${formaction}" method="post" id="viewForm"
		...
		<c:if test="${op eq '查看'}">
			...
			<table>
				...
				<tr>
					<td colspan="2"><textarea   cols="3" style="width:823px">${entity.audittext}</textarea></td>
				</tr>
			</table>
			</div>
		</c:if>
		<c:if test="${op eq '审核'}">
			...
			<table>
				...
				<tr>
					<td colspan="2"><form:textarea  path="audittext" cols="3" cssStyle="width:823px"></form:textarea></td>
				</tr>
			</table>
			</div>
		</c:if>
