...
<div id="importdialog" title="文件导入">
	<table>
		<tr>
			<td>1.下载<!-- <a href="${ctx }/excel/workschedule/导入工作计划_新模板.xlsx" target="_blank">工作计划模板</a>；-->
			<a href="javascript:void(0);" onclick="downloadtemplate();">工作计划模板</a>；<br>
			    2.按照模板的要求进行填写；<br>
...
$(function(){
	var import_uploader = WebUploader.create({
		...
		// 文件接收服务端。
		server : '${ctx }/util/importExcelController/imp.do',
		// 选择文件的按钮。可选。
		pick : '#import'
	});
...
function downloadtemplate(){
	var url = "${ctx }/workschedule/plan/downloadtemplate.do";
