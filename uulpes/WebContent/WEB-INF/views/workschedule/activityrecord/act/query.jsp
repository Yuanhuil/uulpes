    ...
    <div class="filterContent">
        <ul>
            <li>
                ...
                <form:input id="queryst" path="starttime" cssClass="input_160"></form:input>
            </li>
            <li>
                <label class="name03">至</label>
                <form:input id="queryet" path="endtime" cssClass="input_160"></form:input>
            </li>
        </ul>
    </div>
        ...
        <div class="buttonLeft">
            <ul>
                <li>
                    ...
                    <!-- <input class="button-small red" type="button" value="下载打印" id="downprint"> -->
                </li>
                <li>
    ...
    $(function() {
        ...
        $("#del").click(function() {
            ...
            layer.confirm('确定要删除所选择记录内容吗?', {
                ...
                $('#psycourse').load("${baseaction }/delselected.do", {
        ...
        $("#queryst").datepicker({ //绑定开始日期
            ...
            onSelect : function(dateText, inst) {
                //设置结束日期的最小日期
                $("#queryet").datepicker('option', 'minDate', new Date(dateText.replace('-', ',')));

            }
        });

        $("#queryet").datepicker({ //设置结束绑定日期
            dateFormat : 'yy-mm-dd',
            changeMonth : true, //显示下拉列表月份
            changeYear : true, //显示下拉列表年份
            showWeek : true, //显示星期
            ...
            onSelect : function(dateText, inst) {
                //设置开始日期的最大日期
                $("#queryst").datepicker('option', 'maxDate', new Date(dateText.replace('-', ',')));
            }
        });
    });
</script>