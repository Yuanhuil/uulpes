...
<div id="viewdialog" title="${op}心理课">
    <form:form action="${formaction}" method="post" id="viewForm" commandName="entity">
        ...
        <table>
            <tr>
                ...
                <td style="width: 10%">
                    <h1>
                        <c:if test="${entity.activitytype eq '3' }">组织老师:</c:if>
                        <c:if test="${entity.activitytype ne '3' }">主讲人:</c:if>
                    </h1>
                </td>
            ...
            <tr>
                ...
                <td style="width: 10%">
                    <h1>
                        <c:if test="${entity.activitytype eq '3' }">次数:</c:if>
                        <c:if test="${entity.activitytype ne '3' }">节数:</c:if>
                    </h1>
                </td>
                <td>${entity.num }</td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <fmt:formatDate pattern="yyyy年MM月dd日 HH时mm分" value="${entity.startactivitytime}" type="both" />
                    至
                    <fmt:formatDate pattern="yyyy年MM月dd日 HH时mm分" value="${entity.endactivitytime}" type="both" />
                </td>
            </tr>
            <tr>
                <td style="width: 10%">
