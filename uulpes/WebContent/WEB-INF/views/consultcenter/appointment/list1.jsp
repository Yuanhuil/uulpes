		...
		<c:forEach items="${list}" var="m">
			<tr>
				...
				<td><input class="button-small white seeValue"
					...
					<shiro:hasPermission name="consultcenter:appointmentmanagement:appointment:delete"><input class="button-small white delValue"
					id="${m.id}"   value="删除" style="width:50px"></shiro:hasPermission></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
