...
<form:form id="queryform" name="form"
	action="/pes/consultcenter/record/list.do" commandName="record"
	method="post">
	...
	<div class="buttonContent">
		<input type="submit" id="query" name="query" value="查询"
				...
				<shiro:hasPermission name="consultcenter:record:personcoach:create"> <input
...
<script type="text/javascript">
	...
	$("#add").on("click", function() {
		...
		var h = '/pes/consultcenter/record/addOrUpdate.do';
		$('#editDiv').html();
