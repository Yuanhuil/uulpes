...
<form:form id="queryform" name="form"
	action="/pes/consultcenter/warningInterveneS/list2.do"
	commandName="warningInterveneS" method="post">
	<!--	<c:if test="${fn:length(xdlist) > 1 }">
		<div class="filterContent">
			<ul>
				...
				<li><label class="name03">班 级</label>
				<form:select path="className" cssClass="dropBox01 input_160" />
				</li>
			</ul>
		</div>
	</c:if>
	...
	<div class="filterContent">
		<ul>
			...
			<li><label class="name03">干预方式</label> <form:select path="type"
					id="type1" class="input_160">
					<option value>请选择</option>
					<form:options items="${interveneType}" itemLabel="name"
						itemValue="state"></form:options>

				</form:select></li>
			<li><label class="name03">干预结果</label> <form:select
					path="result" id="result1" class="input_160">
					<option value>请选择</option>
