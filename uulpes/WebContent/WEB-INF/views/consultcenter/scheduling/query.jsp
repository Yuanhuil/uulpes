	...
	<div class="filterContent">
		<ul>
			...
			<li><label class="name03">咨询方式</label> <form:select
					path="consultationmodeid" items="${consultationModels}"
					itemLabel="name" itemValue="id"></form:select></li>
		</ul>
	</div>
	<div class="filterContent">
		<ul>
			<li><label class="name03">姓名</label> <input type="userid"
				id="userid" class="input_160"></li>
