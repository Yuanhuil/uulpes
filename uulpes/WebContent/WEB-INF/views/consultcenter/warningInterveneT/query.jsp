...
<form:form id="queryform1" name="form"
	action="/pes/consultcenter/warningInterveneT/list.do"
	...
	<div class="buttonContent">
        <shiro:hasPermission name="consultcenter:warning:autowarning:create">
		<input type="button" id="add1" value="添加" class="button-mid blue" />
        </shiro:hasPermission>
        <input type="submit" id="query1" name="query" value="查询" class="button-mid blue" />
        <input type="button" name="clear" id="clear1" value="重置" class="button-mid blue" />
	</div>
</form:form>
