...
<div id="tab-container" class='tab-container'>
	...
	<div id="tabs2-html" class="table01">
		<form:form id="studentTeamReportForm" name="studentTeamReportForm"
			method="post" commandName="reportLookTeacherFilterParam"
			target="testInfoTab">
			<div style="text-align: center">
				<ul>
					...
					<li><label>量表名称</label> <form:select id="scaleName"
							...
							<form:options items="${scaleList }" itemLabel="title"
								itemValue="code" />
						</form:select></li>


				</ul>
				<input id="roleName" value="${roleName}" style="display:none">
...
<script type="text/javascript">
	...
	function submit1() {
		...
		var h = '/pes/scaletoollib/reportlook/teaTeamReportsSchoolurl.do';
		/*$('#testInfoTab').load(h); */
