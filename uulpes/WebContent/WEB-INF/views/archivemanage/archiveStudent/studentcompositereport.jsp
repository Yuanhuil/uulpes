...
<c:set var="basepath" value="${pageContext.request.contextPath}/assessmentcenter/report"/>
<div class="title" style="float:none"><h1>个人测评报告</h1></div>
<div class="P_title" >
...
<h3>测评时间:${result.testtime}次序:第${result.testnum}次</h3>
 ...
 <c:if test="${not empty result.imageUrl}"><div class="chart"><img src='${basepath}/reportchart.do?${result.imageUrl}'/></div></c:if>
</c:forEach>
</div>
