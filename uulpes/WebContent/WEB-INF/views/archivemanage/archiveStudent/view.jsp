...
<body>
    ...
    <script type="text/javascript">
                    ...
                    $("#testInfo")
                            .click(
                                    function() {
                                        ...
                                        var h = '/pes/archivemanage/archiveStudent/studentCompositeReport.do?resultId=2&userid='
                                                + $("#userid").val() + pp;
                                        ;
                                        $('#testInfoTab').load(h);
                                    });
                    ...
                    $("#recordInfo").click(function() {
                        ...
                        var h = '/pes/archivemanage/archiveStudent/studentRecord.do?sfzjh=' + $("#sfzjh").val() + pp;
                        ;
                        $('#recordInfoTab').load(h);
                    });
                    $("#interventionInfo").click(
                            function() {

                                var h = '/pes/archivemanage/archiveStudent/warningIntervene.do?status=4&sfzjh='
                                        + $("#sfzjh").val() + pp;
                                ;
