...
<form:form id="queryform" name="form"
	action="/pes/taolstation/taoReception/list.do" commandName="taoReception"
	method="post">
	<div class="filterContent">
		<ul>
			<li><label class="name03">来访者</label> <input type="text"
				class="input_160" id="visitor1" name="visitor"></li>
			<li><label class="name03">接待者</label> <form:select
...
<script type="text/javascript">
	...
	$("#add").on("click", function() {
		...
		var h = '/pes/taolstation/taoReception/addOrUpdate.do';
		$('#editDiv').html();
