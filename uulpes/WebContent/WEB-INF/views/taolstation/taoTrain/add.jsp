...
<div id="dialog-form1" title="编辑">
	<form:form id="editForm" method="post" commandName="taoTrain"
		action="/pes/taolstation/taoTrain/save.do">
		<form:hidden path="id" />
		...
		<div class="filterContent">
			<ul>
				<li><form:label path="name"
						class="name04">培训名称</form:label> <form:input
						path="name" class="input_160" />
				</li>
				<li><label class="name04">培训讲师</label> <form:select
