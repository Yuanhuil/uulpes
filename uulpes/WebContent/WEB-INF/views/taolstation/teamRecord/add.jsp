...
<div id="dialog-form1" title="编辑">
	<form:form id="editForm" method="post" commandName="record"
		action="/pes/consultcenter/teamRecord/save.do">
		<form:hidden path="id" />
		...
		<div class="filterContent">
			<ul>
				...
				<li><label class="name04">咨询员</label> <form:select path="teacherid" value="1" class="input_160" items="${teachers}" itemLabel="xm" itemValue="id">
					</form:select>
				</li>
