...
<body>
  <table width="719px" border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#52B1CD">
	...
	<c:if test="${not empty page.mentalDesc}">
	<tr height="155"><td width="10%" align="center"><strong>心<br>理<br>健<br>康<br>评<br>语<strong></td>
	<td valign="top" colspan="4">&nbsp;&nbsp;${page.mentalDesc}</td></tr></c:if>
	<c:if test="${not empty page.personalityDesc }">
	<tr height="225"><td width="10%" align="center"><strong>人<br>格<br>评<br>语<strong></td>
	<td valign="top" colspan="4">&nbsp;&nbsp;${page.personalityDesc}</td></tr></c:if>
	
	<c:if test="${not empty page.potentialDesc }">
	<tr height="225"><td width="10%" align="center"><strong>智<br>能<br>评<br>语<strong></td>
	<td valign="top" colspan="4">&nbsp;&nbsp;${page.potentialDesc}</td></tr></c:if>
	<tr><td width="10%" align="center"><strong>体<br>育<br>评<br>语<strong></td>
	<td valign="top" colspan="4">&nbsp;&nbsp;${page.medicalDesc}</td></tr>
