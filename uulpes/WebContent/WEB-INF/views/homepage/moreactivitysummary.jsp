...
<form id="moreactivitysummaryqeryform" name="moreactivitysummaryqeryform" action="${ctx }/homepage/moreactivitysummary.do"></form>
...
<div id="tablelist" >
	<%@include file="activitysummarytablelist.jsp"%>
