...
<form id="moreactivityplanqueryform" name="moreactivityplanqueryform" action="${ctx }/homepage/moreactivityplan.do"></form>
<div class="morepublicindexContent">
  <div class="publicContentMore"><div class="titleBar">
<div class="titleIndex">活动计划</div>
<div class="more"></div>
</div>
<form id="queryform" name="form"
	action="${ctx}/homepage/moreactivityplan.do" method="post">

</form>
<div class="messageList04">
<div id="tablelist" >
	<%@include file="activityplantablelist.jsp"%>
