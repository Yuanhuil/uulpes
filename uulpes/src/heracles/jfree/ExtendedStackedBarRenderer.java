...
public class ExtendedStackedBarRenderer extends StackedBarRenderer {
     ...
     * 
     */
    private static final long serialVersionUID = 5569573552566720742L;
    ...
    public void drawItem(Graphics2D graphics2d, CategoryItemRendererState categoryitemrendererstate,
        ...
        double d1 = categoryaxis.getCategoryMiddle(j, getColumnCount(), rectangle2d, categoryplot.getDomainAxisEdge())
        ...
        if (categoryitemlabelgenerator != null && isItemLabelVisible(i, j))
            drawItemLabel(graphics2d, categorydataset, i, j, categoryplot, categoryitemlabelgenerator, double1,
                    d < 0.0D);
        if (d > 0.0D) {
            if (showPositiveTotal && isLastPositiveItem(categorydataset, i, j)) {
                ...
                TextUtilities.drawRotatedString(totalFormatter.format(d9), graphics2d, f, f2, textanchor, 0.0D,
                        TextAnchor.CENTER);
            }
            ...
            TextUtilities.drawRotatedString(totalFormatter.format(d10), graphics2d, f1, f3, textanchor1, 0.0D,
                    TextAnchor.CENTER);
        }
        if (categoryitemrendererstate.getInfo() != null) {
            ...
            if (entitycollection != null) {
                ...
                CategoryItemEntity categoryitementity = new CategoryItemEntity(double1, s, s1, categorydataset,
                        categorydataset.getRowKey(i), categorydataset.getColumnKey(j));
