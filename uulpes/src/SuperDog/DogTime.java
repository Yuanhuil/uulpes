...
public class DogTime {
    ...
    private static native int DatetimeToDogtime(int day, int month, int year, int hour, int minute, int second,
            long time[]);

    private static native int DogtimeToDatetime(long time, int day[], int month[], int year[], int hour[], int minute[],
            int second[]);
     ...
     *            input second
     */
    public DogTime(int year, int month, int day, int hour, int minute, int second) {
