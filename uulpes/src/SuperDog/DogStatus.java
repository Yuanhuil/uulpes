...
public class DogStatus {
    ...
    /**
     * Required XML tags not found; Contents in binary data are missing or
     * invalid
     */
    ...
    /**
     * Acknowledge data requested by the update; however the ack_data input
     * parameter is NULL
     */
     ...
     * sequence with the update counter in the SuperDog. The values of the
     * update counter in the file are lower than those in the SuperDog.
     */
    public static final int DOG_UPDATE_TOO_OLD = 54;

    /**
     * Trying to install a V2C file with an update counter that is out of
     * sequence with the update counter in the SuperDog. The first value of the
     * update counter in the file is greater than the value in the SuperDog.
     */
    ...
    /**
     * Requested function not implemented; In the case of the API Dispatcher;
     * API DLL too old
     */
