...
public class StudentGroupReportForSubSchool {
    ...
    public StudentGroupReportForSubSchool(String cityname, String[] zsxxorgids, String scaleid, String njmc,
        ...
        for (int i = 0; i < zsxxorgids.length; i++) {
            ...
            Map<?, ?> param = UtilMisc.toMap("orgid", xxorgid, "scaleid", scaleid, "njmc", njmc, "starttime", starttime,
                    "endtime", endtime);
            List<Map> stuCountMapList = examResultMapper.queryStuGroupStaticForCitySubSchool(param);
    ...
    public String buildWholeStaticTable() {
        HtmlTable table = new HtmlTable("表1 直属学校" + njmc + "测评对象统计量");
    ...
    public String buildRootDimWarningStaticTable() {
        ...
        if (scale.isWarningOrNot())
            table.setCaption("表2 直属学校" + njmc + "学生测评预警结果统计");
        else
            table.setCaption("表2 直属学校" + njmc + "学生测评得分结果统计");
