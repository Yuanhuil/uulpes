...
public class StudentGroupReportForCounty {
    ...
    public StudentGroupReportForCounty(String countyname, String countyid, String scaleid, String njmc,
        ...
        for (int i = 0; i < schoolids.length; i++) {
            ...
            Map<?, ?> param = UtilMisc.toMap("countyid", countyid, "orgid", orgid, "scaleid", scaleid, "njmc", njmc,
                    "starttime", starttime, "endtime", endtime);
            List<Map> stuCountMapList = examResultMapper.queryStuGroupStaticForCounty(param);
    ...
    public void incExmresult(ExamResult examResult) {
        if (currentUserId != examResult.getUserId()) {
            ...
            // String xxmc = schoolMap.get(String.valueOf(orgid));
    ...
    public String buildWholeStaticTable() {
        HtmlTable table = new HtmlTable("表1" + countyname + njmc + "测评对象统计量");
    ...
    public String buildRootDimWarningStaticTable() {
        ...
        if (scale.isWarningOrNot())
            table.setCaption("表2 " + countyname + njmc + "学生测评预警结果统计");
        else
            table.setCaption("表2 " + countyname + njmc + "学生测评得分结果统计");
