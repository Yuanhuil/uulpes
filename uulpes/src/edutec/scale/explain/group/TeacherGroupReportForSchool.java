...
public class TeacherGroupReportForSchool {
    ...
    public TeacherGroupReportForSchool(long orgid, String scaleid, int roleid, String rolename, String starttime,
            String endtime) {
        ...
        Map<?, ?> param = UtilMisc.toMap("orgid", orgid, "scaleid", scaleid, "roleid", roleid, "starttime", starttime,
                "endtime", endtime);
        List<Map> teaCountMapList = examResultMapper.queryTeaGroupStaticForSchool(param);
    ...
    public Map<Object, Object> complete(String roleName) {
        Map<Object, Object> page = new HashMap<Object, Object>();
        String wholeStaticTable;

        wholeStaticTable = buildWholeStaticTable(roleName);

        // wholeStaticTable = buildWholeStaticTable();
        String rootDimWarningStatTable = buildRootDimWarningStaticTable(roleName);
     ...
     * @return
     */
    public String buildWholeStaticTable(String roleName) {
        HtmlTable table = new HtmlTable("表1" + roleName + "测评对象统计量");
     ...
     * @return
     */
    public String buildRootDimWarningStaticTable(String roleName) {
        HtmlTable table = new HtmlTable();

        if (scale.isWarningOrNot())
            table.setCaption("表2 " + roleName + "测评预警结果统计");
        else
            table.setCaption("表2 " + roleName + "测评得分结果统计");
