...
public class TeacherGroupReportForCity {
    ...
    public TeacherGroupReportForCity(String cityname, String[] qxArray, String scaleid, int roleid, String rolename,
        ...
        for (int i = 0; i < qxArray.length; i++) {
            ...
            Map<?, ?> param = UtilMisc.toMap("countyid", countyid, "scaleid", scaleid, "roleid", roleid, "rolename",
                    rolename, "starttime", starttime, "endtime", endtime);
            List<Map> teaCountMapList = examResultMapper.queryTeaGroupStaticForCity(param);
    ...
    public String buildWholeStaticTable() {
        HtmlTable table = new HtmlTable("表1" + cityname + rolename + "测评对象统计量");
    ...
    public String buildRootDimWarningStaticTable() {
        ...
        if (scale.isWarningOrNot())
            table.setCaption("表2 " + cityname + rolename + "教师测评预警结果统计");
        else
            table.setCaption("表2 " + cityname + rolename + "教师测评得分结果统计");
        ...
        for (int i = 0; i < dimStatList.size(); i++) {
            ...
            if (level == 1) {
                if (i == 0) {
                    ...
                    sb2.append("说明教师在").append(kv.getKey()).append("的问题最严重，检出数为").append(kv.getValue().getWn1());
                    sb2.append("人，占总样本的");
            ...
            if (level == 2) {
                if (i == 0) {
                    sb1.append(kv.getKey()).append("。然后依次是");
                    sb2.append("说明教师在").append(kv.getKey()).append("的问题最严重，检出数为").append(kv.getValue().getWn2());
                    sb2.append("人，占总样本的");
            ...
            if (level == 3) {
                if (i == 0) {
                    sb1.append(kv.getKey()).append("。然后依次是");
                    sb2.append("说明教师在").append(kv.getKey()).append("的问题最严重，检出数为").append(kv.getValue().getWn3());
                    sb2.append("人，占总样本的");
            ...
            if (level == 4) {
                if (i == 0) {
                    sb1.append(kv.getKey()).append("。然后依次是");
                    sb2.append("说明教师在").append(kv.getKey()).append("的问题最严重，检出数为").append(kv.getValue().getWn4());
                    sb2.append("人，占总样本的");
            ...
            if (level == 5) {
                if (i == 0) {
                    sb1.append(kv.getKey()).append("。然后依次是");
                    sb2.append("说明教师在").append(kv.getKey()).append("的问题最严重，检出数为").append(kv.getValue().getWn5());
                    sb2.append("人，占总样本的");
