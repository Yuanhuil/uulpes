        ...
        try {
            ...
            if (strs.size() == 1) {
                ...
                if (direct.equalsIgnoreCase("static")) {
                   ...
                   * else if (direct.equalsIgnoreCase("list")) { List list =
                   * (List) Resources.callStaticMethod(mothedOrStr); for (Object
                   * obj : list) { map = new LinkedHashMap(); if (obj instanceof
                   * KeyValue) { KeyValue keyValue = (KeyValue) obj;
                   * map.put(keyValue.getKey(), keyValue.getValue()); } else if
                   * (obj instanceof Titleable) { Titleable titleable =
                   * (Titleable) obj; map.put(titleable.getObjectIdentifier(),
                   * titleable.getTitle()); } else {
                   * 
                   * } } }
